...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-41937e82');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-41937e82');}
...
var brandEl=document.querySelector('.rl-brand-41937e82');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
